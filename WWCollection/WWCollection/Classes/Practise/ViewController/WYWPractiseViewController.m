...
#import "WYWPractiseViewController.h"

#import "WYWPraciseLoopView.h"

@interface WYWPractiseViewController ()
@property (nonatomic,strong) WYWPraciseLoopView *practiseLoopView;

@end

@implementation WYWPractiseViewController
...
- (void)setupUI{
    ...
    titleStringArray = @[@"000000000",@"0000001",@"000000002"];
